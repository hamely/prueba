                    ...
                    <div class="panel panel-default">
                      <div class="panel-body">
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                                <label for="email">Fecha de movimiento</label>
                                <input type="date" class="form-control" id="fechacambiounidad" name="fechacambiounidad" placeholder="SIGLAS">
                            </div>
                          </div> 
...
@section('script')
   <script>
   	...
   	$("#enviarMovimientoPersonalIncluir").click(function( event ) {
        ...
        var Fechacambiounidad=$('#fechacambiounidad').val();
        var Combounidad=$('#comboUnidad').val();
        var Combocargo=$('#comboCargo').val();
        var Observacion=$('#observacion').val();

        $.ajax({
                 url:'{{ route('insertMovimientoCambioUnidad') }}',
                 type: 'POST',
                 data:{
                        "_token": "{{ csrf_token() }}",
                        "idPersona":Idpersona,
                        ...
                        "fechacambiounidad":Fechacambiounidad,
