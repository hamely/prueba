            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  ...
                  <a href="{{('movimientocambiohorariocreate')}}" class="btn btn-success "><i class="fa fa-plus-circle"> Nuevo</i></a>
                    <h2>Lista de función policial y modalidad de horario<small></small></h2>
