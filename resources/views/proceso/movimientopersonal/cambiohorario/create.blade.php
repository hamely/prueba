          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Cambio de función policial y modalidad de horario</h3>
              </div>
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="fechacambiohorario" name="fechacambiohorario" placeholder="SIGLAS">
                            </div>
                          </div> 
...
@section('script')
   <script>
   	...
   	$("#enviarMovimientoPersonalIncluir").click(function( event ) {
        ...
        var Fechacambiohorario=$('#fechacambiohorario').val();
        var Combohorario=$('#comboHorario').val();
        var Observacion=$('#observacion').val();

        $.ajax({
                 url:'{{ route('insertMovimientoCambioHorario') }}',
                 type: 'POST',
                 data:{
                        "_token": "{{ csrf_token() }}",
                        "idPersona":Idpersona,
                        ...
                        "fechacambiohorario":Fechacambiohorario,
