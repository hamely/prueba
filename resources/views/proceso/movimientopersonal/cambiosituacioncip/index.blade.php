          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>CAMBIO DE DITUACIÓN DE CIP<small></small></h3>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  ...
                  <a href="{{('movimientocambiositucioncipcreate')}}" class="btn btn-success "><i class="fa fa-plus-circle"> Nuevo</i></a>
                    <h2>Lista de cambio de situación de cip<small></small></h2>
