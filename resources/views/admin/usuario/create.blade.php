                    ...
                    {!! Form::open(['route' => ['usuario.store'] , 'method' => 'POST', 'class' => 'form-horizontal','enctype' => 'multipart/form-data' ]) !!}
                      ...
                      <div class="item form-group">
                        ...
                        <!--{!!Form::text('name',null, ['class' => 'form-control btn-sm' , 'id' => 'nombre','autocomplete' => 'off'])!!}-->
                          <input id="name"  name="name"  class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" placeholder="Ingrese nombre del usuario" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
