                  ...
                  <div class="x_content">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="codigo" name="codigo" value="{{ old('codigo') }}"  data-validate-minmax="10,100" placeholder="Ingrese código de licencia" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="nombre"  name="nombre" value="{{ old('nombre') }}"  class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" placeholder="Ingrese nombre de licencia" type="text">
